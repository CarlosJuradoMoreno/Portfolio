...
export const metadata: Metadata = {
  title: "Carlos Jurado — Senior Software Engineer",
  ...
  openGraph: { title: "Carlos Jurado — Senior Software Engineer", description: "Building dependable systems for meaningful scale.", type: "website" },
};
